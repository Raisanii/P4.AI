// P4.AI — COMPLETE task endpoint (TASK-07, §7.5.1).
//
// POST /api/task/[id]/complete — STUDENT only.
// Transitions AssignmentProgress IN_PROGRESS → DONE via the state machine.
...
export async function POST(
  ...
  try {
    ...
    // Body is optional for COMPLETE — ignore parse errors.
  }
